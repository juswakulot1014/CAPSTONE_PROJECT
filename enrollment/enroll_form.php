    ...
    <?php else: ?>
        ...
        <div class="review-container">
            ...
            <div class="review-section">
                ...
                <?php if (!empty($_SESSION['uploaded_files'])): ?>
                    <h5 class="mt-3 mb-2"><i class="fas fa-paperclip text-primary me-2"></i>Uploaded Files (<?= count($_SESSION['uploaded_files']) ?>)</h5>
                    <ul class="list-unstyled mb-0">
                        <?php foreach ($_SESSION['uploaded_files'] as $f):
                            $size_kb = isset($f['data']) ? round(strlen(base64_decode($f['data'])) / 1024, 1) : 0;
                        ...
                        ?>
                            <li class="mb-2 d-flex align-items-center gap-2">
                                ...
                                <span class="text-muted small">(<?= $size_kb ?> KB)</span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
